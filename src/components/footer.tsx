...
const Footer: React.FC = () => {
  return (
    <div className="text-white w-[100vw] top-20 z-30 relative overflow-auto pt-10 bg-gray-800 mt-[3%]">
      <div className="overflow-auto ml-[4%] mr-[4%] ">
        <div className="sm:flex block justify-between pb-6">
          <div className="sm:w-[27.3%] w-full">
            ...
            <p>I am a Full Stack Developer | Leaning never ends</p>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <a className="hover:text-blue-500" href="#service">
                  Service
                </a>
              </li>
              <li>
                <a className="hover:text-blue-500" href="#portfolio">
                  Portfolio
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul>
              ...
              <li className="flex gap-2 items-center">
                ...
                niyonkurubbertin@gmail.com
              </li>
            </ul>
          </div>
        </div>
        <p className="flex gap-2 items-center justify-center border-t-[1px] border-black ">
          <FaRegCopyright /> {new Date().getFullYear()} Niyonkuru Bertin. All
          rights reserved.
        </p>
      </div>
    </div>
